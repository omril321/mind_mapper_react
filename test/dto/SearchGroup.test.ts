...
describe('SearchGroup', () => {
    it('should return the members when using getter', () => {
        ...
        const member1: SearchGroupMember = {visit: historyVisitFor("some url", "title1"), score: new RelatednessScore(0.5)};
        const member2: SearchGroupMember = {visit: historyVisitFor("another url", "another title"), score: new RelatednessScore(1)};
    ...
    it('should return only members with at least relatedness', () => {
        ...
        const member1: SearchGroupMember = {visit: historyVisitFor("some url", "title1"), score: new RelatednessScore(0.5)};
        const member2: SearchGroupMember = {visit: historyVisitFor("another url", "another title"), score: new RelatednessScore(1)};
        const member3: SearchGroupMember = {visit: historyVisitFor("url3", "title..."), score: new RelatednessScore(0)};
