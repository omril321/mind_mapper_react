...
describe('SearchGroup', () => {
    it('should return the members when using getter', () => {
        ...
        const member1: SearchGroupMember = {visit: historyVisitFor("some url", "title1"), score: 0.5};
        const member2: SearchGroupMember = {visit: historyVisitFor("another url", "another title"), score: 1};
